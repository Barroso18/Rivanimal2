...
if($funcion === 'actualizaAnimal'){
    ...
    if (!empty($foto)) {
        $sql = "UPDATE animal SET 
            ...
            WHERE id_animal=?";
        $stmt = $conn->prepare($sql);
        $stmt->bind_param("ssssissssidssssissi", $nombre, $clase, $raza, $sexo, $identificador, $tamaño, $situacion, $fechaNacimiento, $fechaEntrada, $nivel, $peso, $descripcion, $foto, $comportamiento, $socializacion, $ppp, $localidad, $disponibilidad, $id_animal);
    } else {
        $sql = "UPDATE animal SET 
            ...
            WHERE id_animal=?";
        $stmt = $conn->prepare($sql);
       $stmt->bind_param("ssssissssidsssissi", $nombre, $clase, $raza, $sexo, $identificador, $tamaño, $situacion, $fechaNacimiento, $fechaEntrada, $nivel, $peso, $descripcion, $comportamiento, $socializacion, $ppp, $localidad, $disponibilidad, $id_animal);
    }
