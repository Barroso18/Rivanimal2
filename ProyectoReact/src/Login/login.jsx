  ...
  return (
    ...
    >
      <div className="flex items-center justify-center gap-4 my-6">
        <img src={`https://rivanimal-gestion.es/imagenes/logoRivanimal.jpg?v=${Date.now()}`} className="h-20 object-contain" alt="Logo Rivanimal" />
        <img src={`https://rivanimal-gestion.es/imagenes/logo-texto.jpg?v=${Date.now()}`} className="h-20 object-contain" alt="Logo texto" />
      </div>
