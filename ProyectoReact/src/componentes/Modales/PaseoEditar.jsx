...
function PaseoEditar({paseos, setPaseos,nombreAnimal,voluntario, onClose}){
    ...
    const [form,setForm] = useState({
        id:paseos.id,
        voluntario:paseos.voluntario,
        animal:paseos.animal,
        lugarPaseo:paseos.lugarPaseo,
        cacas: paseos.cacas,
        duracion: paseos.duracion,
        descripcion:paseos.descripcion
    });
    //////////////////////////////////////
    ...
    const enviaFormulario = async (e) =>{
        ...
        if(await validar()){
            ...
            try {
                ...
                const response = await servicioPaseos.update(paseos.id,editarPaseo);
        ...
        <div>
            ...
            <form onSubmit={enviaFormulario}>
                ...
                <select
                    ...
                    <option value={paseos.lugarPaseo.toUpperCase()}>{paseos.lugarPaseo.toUpperCase()}</option>
