...
function ReporteGatoCrear({ animal, voluntario, onClose }) {
    const { user } = useAuth();
    ...
    const enviaFormulario = async (e) => {
        ...
        await servicioReporteGatos.registro(formData)
            .then((response) => {
            ...
            {!mostrarModalReporte && (
                <div className="fixed inset-0 bg-black bg-opacity-30 flex items-center justify-center z-50 p-4 overflow-y-auto">
                    <div className="relative bg-white rounded-lg shadow-lg w-full max-w-4xl max-h-[90vh] overflow-y-auto p-6">
                        ...
                        <h3 className="text-2xl font-bold text-center text-gray-800 mb-6">Reporte de {animal.nombre}</h3>
...
export default ReporteGatoCrear;